...
rm -rf results/W2_gemini_flash_n600 results/gemini_flash_n600.log
nohup .venv-controlarena/bin/python scripts/w2_generate_family.py --family gemini_flash_n600 \
  ...
  --log-dir results/W2_gemini_flash_n600 \
  > results/gemini_flash_n600.log 2>&1 < /dev/null &
disown
echo "launched n600 pid $!"
